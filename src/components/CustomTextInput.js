...
export default class CustomTextInput extends Component {
  ...
  render() {
    const { isEnabled, onPress, placeholderTextColor, ...otherProps } = this.props;
      ...
      <View style={styles.container}>
        <View
          ...
          <TextInput
            ...
            autoCapitalize={'none'}
            autoCorrect={false}
            style={[styles.textInput, inputStyle , { color }]}
            maxLength={32}
            underlineColorAndroid={'transparent'}
            placeholderTextColor={ placeholderTextColor != undefined? placeholderTextColor :'#6B609A'}
